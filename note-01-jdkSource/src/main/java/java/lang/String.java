...
public final class String
    ...
    /*字符串值存储容器,也就是说，String的底层实现是char[]*/
    ...
    /*依照对象序列化规范,将字符串对象写入ObjectOutputStream，类字符串在序列化流协议中较为特殊*/
    ...
    public String() {
        this.value = "".value;
        System.out.println("无参构造的hash为： " + this.hash);
    }
    ...
    public String(String original) {
        ...
        System.out.println("有参构造的hash为：" + this.hash);
    }
