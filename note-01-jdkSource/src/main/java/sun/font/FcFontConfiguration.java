...
public class FcFontConfiguration extends FontConfiguration {
    ...
    private FontConfigManager.FontConfigFont[] getFcFontList(FontConfigManager.FcCompFont[] fcFonts,
    ...
    public CompositeFontDescriptor[] get2DCompositeFontInfo() {
        ...
        for (int fontIndex = 0; fontIndex < NUM_FONTS; fontIndex++) {
            ...
            for (int styleIndex = 0; styleIndex < NUM_STYLES; styleIndex++) {
                ...
                FontConfigManager.FontConfigFont[] fcFonts =
    ...
    private void writeFcInfo() {
        ...
        for (int i=0; i<fcCompFonts.length; i++) {
            FontConfigManager.FcCompFont fci = fcCompFonts[i];
